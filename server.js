...
app.use(cors({
    origin: ["http://localhost:3000", "https://fishonworldtour.up.railway.app","http://127.0.0.1:3000","https://incident-pi.vercel.app"], // Allow both localhost and deployed frontend
    methods: ["GET", "POST"],
    credentials: true
}));
